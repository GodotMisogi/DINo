...
# Conditioning parameters for non-Markovian models
# if not is_markovian:
...
if is_markovian:
    (
        ...
        n_frames_train=n_frames_train,
        lr_adapt=lr_adapt,
        dataset_params=dataset_ts_params,
        n_steps=n_steps,
        save_best=True,
    )
...
#                 )
#     logger.info(
#         "Dataset %s, Runid %s, Loss_ts: %.3e In-t: %.3e"
#         % (input_dataset, ts, loss_ts, loss_ts_in_t)
#     )
#     logger.info("========")
